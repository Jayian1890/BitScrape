 ...
 * 
 * BencodeDecoder is responsible for decoding bencode data to BencodeValue objects.
 */
...
public:
     ...
     * @return Future containing the decoded BencodeValue
     */
    virtual std::future<BencodeValue> decode_async(const uint8_t* data, size_t size) = 0;
};
