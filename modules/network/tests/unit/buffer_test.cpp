...
TEST(BufferTest, AppendData) {
    ...
    EXPECT_EQ(buffer.size(), sizeof(data1));
    
    buffer.append(data2, sizeof(data2));
    EXPECT_EQ(buffer.size(), sizeof(data1) + sizeof(data2));
...
TEST(BufferTest, AppendBuffer) {
    ...
    EXPECT_EQ(buffer1.size(), sizeof(data1) + sizeof(data2));
...
TEST(BufferTest, ToVector) {
    ...
    EXPECT_EQ(vec.size(), sizeof(data));
...
TEST(BufferTest, ReadAt) {
    ...
    EXPECT_EQ(bytes_read, sizeof(read_data));
