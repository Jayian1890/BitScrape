...
TEST_F(TrackerResponseTest, AnnounceResponse) {
    ...
    EXPECT_EQ(response.peers()[0].host(), "192.168.1.1");
    EXPECT_EQ(response.peers()[0].port(), 6881);
    EXPECT_EQ(response.peers()[1].host(), "192.168.1.2");
    ...
    EXPECT_EQ(response.peers()[0].host(), "192.168.1.3");
    EXPECT_EQ(response.peers()[0].port(), 6883);
    EXPECT_EQ(response.peers()[1].host(), "192.168.1.4");
    EXPECT_EQ(response.peers()[1].port(), 6884);
    EXPECT_EQ(response.peers()[2].host(), "192.168.1.5");
